...
<button
  onClick={() => googleLogin()}
  class="flex items-center justify-center border border-button-border-light rounded-md p-2 pr-3 hover:bg-gray-100"
...
>
  <div class="flex items-center justify-center bg-white w-9 h-9 rounded-l">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
      ...
      <path
        ...
        class="fill-current" // Apply fill-current to fill the icon with the current button color
      ></path>
      <path
  ...
  <span class="text-sm text-gray-700 font-medium tracking-wider ml-2">Sign in with Google</span>
</button>
